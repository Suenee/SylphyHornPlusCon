...
namespace SylphyHorn.Serialization
{
	public class GeneralSettings : SettingsHost
	{
		...
		public SerializableProperty<string> WebSocketApiKeyProtected => this.Cache(key => new SerializableProperty<string>(key, this._provider));
		public SerializableProperty<bool> WebSocketAutoConnect => this.Cache(key => new SerializableProperty<bool>(key, this._provider, false));
