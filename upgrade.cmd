...
:check_tracked_clean
rem Ignore untracked content inside submodules (for example bin/obj generated by
rem restore/build), but still reject real tracked edits, staged edits, and gitlink changes.
